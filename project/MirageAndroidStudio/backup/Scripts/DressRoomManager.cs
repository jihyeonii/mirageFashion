...
public class DressRoomManager : MonoBehaviour {
    ...
    void Start () {
        ...
        locker = new GameObject[4];
        lockerEdit = new GameObject[4];
        ...
        locker[3] = lockerObj.transform.Find("locker_3").gameObject;
        lockerPos = new GameObject[4];
        ...
        lockerPos[3] = lockerObj.transform.Find("locker3_pos").gameObject;
        ...
        lockerEdit[3] = locker[3].transform.Find("btnAdd,Remove").gameObject;
        ...
        if(PlayerPrefs.GetString("locker3_body").Contains("char"))
        {
            dicLockerChar.Add("char3", new CharacterInfo(PlayerPrefs.GetString("locker3_body"), PlayerPrefs.GetString("locker3_top"), PlayerPrefs.GetString("locker3_bottom"), PlayerPrefs.GetString("locker3_onepiece"), PlayerPrefs.GetString("locker3_shoes"), PlayerPrefs.GetString("locker3_acc")));
        }
        else
        {
    ...
    void Update() {
        ...
        else
        {
            ...
            if(lockerNum == 2) {
                locker[0].transform.localScale = new Vector3(0.6f, 0.6f, 0.6f);
                locker[1].transform.localScale = new Vector3(0.8f, 0.8f, 0.8f);
                locker[3].transform.localScale = new Vector3(0.8f, 0.8f, 0.8f);
            }
            else if(lockerNum == 1)
            {
                locker[0].transform.localScale = new Vector3(0.8f, 0.8f, 0.8f);
                locker[2].transform.localScale = new Vector3(0.8f, 0.8f, 0.8f);
                locker[3].transform.localScale = new Vector3(0.6f, 0.6f, 0.6f);
            }
            else if (lockerNum == 0)
            {
                locker[1].transform.localScale = new Vector3(0.8f, 0.8f, 0.8f);
                locker[2].transform.localScale = new Vector3(0.6f, 0.6f, 0.6f);
                locker[3].transform.localScale = new Vector3(0.8f, 0.8f, 0.8f);
            }
            else if(lockerNum == 3)
            {
                locker[0].transform.localScale = new Vector3(0.8f, 0.8f, 0.8f);
                locker[1].transform.localScale = new Vector3(0.6f, 0.6f, 0.6f);
                locker[2].transform.localScale = new Vector3(0.8f, 0.8f, 0.8f);
            }
        }
    ...
    public void trun()// 0:L, 1:R
    {
        ...
        if (lockerNum == 2)
        {
            if(direction == 1)
            {
                ...
                locker[3].transform.SetSiblingIndex(1);
                locker[2].transform.SetSiblingIndex(3);
            }
            else
            {
                locker[0].transform.SetSiblingIndex(0);
                locker[1].transform.SetSiblingIndex(1);
                locker[3].transform.SetSiblingIndex(2);
                locker[2].transform.SetSiblingIndex(3);
            }
            ...
            locker[1].transform.position = Vector3.MoveTowards(locker[1].transform.position, lockerPos[3].transform.position, speed * Time.smoothDeltaTime);
            ...
            locker[3].transform.position = Vector3.MoveTowards(locker[3].transform.position, lockerPos[1].transform.position, speed * Time.smoothDeltaTime);
            locker[0].transform.localScale = Vector3.Lerp(locker[0].transform.localScale, lockerPos[2].transform.localScale, 0.03f);
            locker[1].transform.localScale = Vector3.Lerp(locker[1].transform.localScale, lockerPos[3].transform.localScale, 0.06f);
            locker[2].transform.localScale = Vector3.Lerp(locker[2].transform.localScale, lockerPos[0].transform.localScale, 0.03f);
            locker[3].transform.localScale = Vector3.Lerp(locker[3].transform.localScale, lockerPos[1].transform.localScale, 0.06f);
        }
        else if (lockerNum == 1)
        {
            if (direction == 1)
            {
                locker[3].transform.SetSiblingIndex(0);
                locker[0].transform.SetSiblingIndex(1);
                locker[2].transform.SetSiblingIndex(2);
                locker[1].transform.SetSiblingIndex(3);
            }
            else
            {
                locker[3].transform.SetSiblingIndex(0);
            ...
            locker[0].transform.position = Vector3.MoveTowards(locker[0].transform.position, lockerPos[3].transform.position, speed * Time.smoothDeltaTime);
            ...
            locker[3].transform.position = Vector3.MoveTowards(locker[3].transform.position, lockerPos[2].transform.position, speed * Time.smoothDeltaTime);
            locker[0].transform.localScale = Vector3.Lerp(locker[0].transform.localScale, lockerPos[3].transform.localScale, 0.06f);
            ...
            locker[3].transform.localScale = Vector3.Lerp(locker[3].transform.localScale, lockerPos[2].transform.localScale, 0.06f);
        }
        else if(lockerNum == 3)
        {
            if(direction == 1)
            {
                ...
                locker[1].transform.SetSiblingIndex(1);
                locker[2].transform.SetSiblingIndex(2);
                locker[3].transform.SetSiblingIndex(3);
            }
            else
            {
                locker[0].transform.SetSiblingIndex(0);
            ...
            locker[2].transform.position = Vector3.MoveTowards(locker[2].transform.position, lockerPos[3].transform.position, speed * Time.smoothDeltaTime);
            locker[3].transform.position = Vector3.MoveTowards(locker[3].transform.position, lockerPos[0].transform.position, speed * Time.smoothDeltaTime);
            locker[0].transform.localScale = Vector3.Lerp(locker[0].transform.localScale, lockerPos[1].transform.localScale, 0.06f);
            locker[1].transform.localScale = Vector3.Lerp(locker[1].transform.localScale, lockerPos[2].transform.localScale, 0.03f);
            locker[2].transform.localScale = Vector3.Lerp(locker[2].transform.localScale, lockerPos[3].transform.localScale, 0.06f);
            locker[3].transform.localScale = Vector3.Lerp(locker[3].transform.localScale, lockerPos[0].transform.localScale, 0.03f);
        }
        else
        {
            if(direction == 1)
            {
                ...
                locker[3].transform.SetSiblingIndex(2);
                locker[1].transform.SetSiblingIndex(1);
                locker[0].transform.SetSiblingIndex(3);
            }
            else
            {
                locker[2].transform.SetSiblingIndex(0);
            ...
            locker[3].transform.position = Vector3.MoveTowards(locker[3].transform.position, lockerPos[3].transform.position, speed * Time.smoothDeltaTime);
            ...
            locker[2].transform.localScale = Vector3.Lerp(locker[2].transform.localScale, lockerPos[2].transform.localScale, 0.06f);
            locker[3].transform.localScale = Vector3.Lerp(locker[3].transform.localScale, lockerPos[3].transform.localScale, 0.06f);
        }
    ...
    public void removeOrAdd(int num)//locker num
    {
        ...
        else
        {
            ...
            if (GameManager.instance.charInfo.body.Contains("char"))
            {
                for (int i = 0; i < 4; i++)
                {
                    if(i != num)
                    {
                        if (dicLockerChar.ContainsKey("char" + i))
                        {
                            if ((GameManager.instance.charInfo.top.Contains("top") && dicLockerChar["char" + i].top == GameManager.instance.charInfo.top) ||
                                (GameManager.instance.charInfo.bottom.Contains("bottom") && dicLockerChar["char" + i].bottom == GameManager.instance.charInfo.bottom) ||
                                (GameManager.instance.charInfo.onepiece.Contains("onepiece") && dicLockerChar["char" + i].onepiece == GameManager.instance.charInfo.onepiece) ||
                                (GameManager.instance.charInfo.shoes.Contains("shoes") && dicLockerChar["char" + i].shoes == GameManager.instance.charInfo.shoes) ||
                                (GameManager.instance.charInfo.acc.Contains("acc") && dicLockerChar["char" + i].acc == GameManager.instance.charInfo.acc) )
                            {
                                //팝업
                                Debug.Log("중복");
                                overlapLocker = true;
            ...
            {
                PopupManager.instance.cameraPopup.transform.Find("CanvasPopup").Find("popup").gameObject.SetActive(true);
                PopupManager.instance.cameraPopup.transform.Find("CanvasPopup").Find("popup").Find("popup").Find("Text").GetComponent<Text>().text = "선택한 의상이 보관함에 이미 저장되어 있습니다.";
                PopupManager.instance.cameraPopup.transform.Find("CanvasPopup").Find("popup").Find("popup").Find("Button").gameObject.SetActive(true);
                PopupManager.instance.cameraPopup.transform.Find("CanvasPopup").Find("popup").Find("popup").Find("Button").localPosition = new Vector3(0, PopupManager.instance.cameraPopup.transform.Find("CanvasPopup").Find("popup").Find("popup").Find("Button").localPosition.y);
                PopupManager.instance.cameraPopup.transform.Find("CanvasPopup").Find("popup").Find("popup").Find("Button2").gameObject.SetActive(false);
            }
        }
        gameObject.transform.Find("btnRevert").transform.gameObject.SetActive(false);
        for (int i = 0; i < 4; i++)
    ...
    public void loadLocker()
    {
        ...
        //GameManager.instance.charCamera.gameObject.SetActive(true);
        //GameManager.instance.charCamera.GetComponent<Camera>().fieldOfView = GameManager.instance.cameraAR.transform.Find("Camera").GetComponent<Camera>().fieldOfView;
        //GameManager.instance.character.SetActive(true);
        ...
        locker[2].transform.LookAt(GameObject.Find("PopupCamera").transform.Find("LookAt").transform);
        locker[2].transform.localScale = new Vector3(0.6f, 0.6f, 0.6f);
        locker[3].transform.LookAt(GameObject.Find("PopupCamera").transform.Find("LookAt").transform);
        locker[3].transform.localScale = new Vector3(0.8f, 0.8f, 0.8f);
        ...
        //PopupManager.settingPage.transform.Find("Image").transform.position = new Vector3(PopupManager.instance.cameraPopup.GetComponent<Camera>().ScreenToWorldPoint(new Vector3(0, 0, 0)).x, PopupManager.settingPage.transform.Find("Image").transform.position.y, PopupManager.settingPage.transform.Find("Image").transform.position.z);
