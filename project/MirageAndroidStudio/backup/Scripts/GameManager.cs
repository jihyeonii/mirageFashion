...
public class GameManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        //애니메이션 스크롤바
        animationScrollBar = canvasCameraUI.transform.Find("panelBottom").Find("AnimationScrollBar").gameObject;
        ...
        GameObject[] locker = new GameObject[4];
        for (int j = 0; j < 4; j++)
        {
    ...
    public void Update()
    {
        ...
        //애니메이션 스크롤
        if(isPlayingAnimation == false && uiState == UIState.camera)
        {
            characterAni.ForceStateNormalizedTime(animationScrollBar.GetComponent<Scrollbar>().value);
        }
        ...
        if (availableRecognize && isPopup == false)
        {
    ...
    public void shopPopup()
    {
        ...
        PopupManager.instance.cameraPopup.transform.Find("CanvasPopup").Find("popup").Find("popup").Find("Text").GetComponent<Text>().text = "구매 페이지로 이동 하시겠습니까?";
        PopupManager.instance.cameraPopup.transform.Find("CanvasPopup").Find("popup").Find("popup").Find("Button").gameObject.SetActive(true);
        PopupManager.instance.cameraPopup.transform.Find("CanvasPopup").Find("popup").Find("popup").Find("Button").localPosition = new Vector3(-130, PopupManager.instance.cameraPopup.transform.Find("CanvasPopup").Find("popup").Find("popup").Find("Button2").localPosition.y);
        PopupManager.instance.cameraPopup.transform.Find("CanvasPopup").Find("popup").Find("popup").Find("Button2").gameObject.SetActive(true);
        PopupManager.instance.cameraPopup.transform.Find("CanvasPopup").Find("popup").Find("popup").Find("Button2").localPosition = new Vector3(130, PopupManager.instance.cameraPopup.transform.Find("CanvasPopup").Find("popup").Find("popup").Find("Button2").localPosition.y);
    }
    ...
    public void goTrackingScene()
    {
        ...
        canvasTopButtonUI.transform.Find("btnPauseAni").gameObject.SetActive(false);
        AndroidFuntionCall.instance.img.gameObject.SetActive(false);
        canvasTopButtonUI.transform.Find("btnCamSwitch").gameObject.SetActive(true);
    ...
    public void goCameraScene()
    {
        ...
        animationScrollBar.SetActive(false);
        CharacterController.instance.GetComponent<TransformGesture>().enabled = true;
        ...
        //애니메이션버튼
        //canvasTopButtonUI.transform.Find("btnPauseAni").gameObject.SetActive(true);
    ...
    public void pauseAnimation()
    {
        ...
        {
            characterAni.StartPlayback();
            animationScrollBar.SetActive(true);
            //CharacterController.instance.GetComponent<TransformGesture>().enabled = false;
            animationScrollBar.GetComponent<Scrollbar>().value = 0;
