...
public class CardInfoManager : MonoBehaviour {
    ...
    public void cardInfoPage()
    {
        float height = (720 / screenWidth) * screenHeight;
            ...
            Transform typeOrignTrans = gameObject.transform.Find("CardInfo").transform.Find("clothType").transform.Find("ScrollRectType").transform.Find("type").transform;
            typeOrignTrans.localPosition = new Vector3(0, typeOrignTrans.localPosition.y, typeOrignTrans.localPosition.z);
