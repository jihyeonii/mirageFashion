...
public class FashionRecognition : MonoBehaviour
{
    ...
    void Update()
    {
        if (GameManager.instance.charInfo.top.Contains("top") || GameManager.instance.charInfo.bottom.Contains("bottom"))
        {
            canvasFashion.transform.Find("Camera").gameObject.SetActive(true);
        }
        else
            canvasFashion.transform.Find("Camera").gameObject.SetActive(false);
    ...
    {
        buttonOnOff(false, false, false, false, false);
    ...
    public void cancel()
    {
        cropBox.gameObject.SetActive(false);
        cropBtn.gameObject.SetActive(false);
        buttonOnOff(true, true, true,false, false);
    ...
    public void recv_parsing()
    {
        ...
        if (receivedData.Length > 0)
        {
            ...
            else if (lCount == 1)
            {
                ...
                GameManager.instance.selectColor = colorArray[lColor];
    ...
    public IEnumerator takePicture()
    {
        ...
        nKey = (long)7300;
        img_bytes = ScaleTexture(AndroidFuntionCall.texture, 720, (int)((720 * Screen.height) / Screen.width)).EncodeToJPG();
        buttonOnOff(false, false, false, true, true);
    ...
    public void buttonOnOff(bool album, bool capture, bool card, bool reCapture, bool send)
    {
    ...
    public void select(GameObject obj)
    {
        ...
        else
        {
            ...
            GameManager.instance.selectColor = obj.name;
            option.transform.Find("List").Find("0").GetComponent<UnityEngine.UI.Image>().sprite = LoadAsset.instance.fashionClothImg[GameManager.instance.selectCloth + "_" + GameManager.instance.selectColor + "_img"];
        }
        obj.transform.Find("check").gameObject.SetActive(true);
    }
    /// <summary>
    ...
    {
        if (GameManager.instance.selectColor !="" && GameManager.instance.selectCloth !="")
        {
            canvasFashion.transform.Find("top").gameObject.SetActive(true);
            canvasFashion.transform.Find("bottom").gameObject.SetActive(true);
            ...
            if(GameManager.instance.selectCloth.Substring(index + 1).Contains("top"))
            {
                ...
                canvasFashion.transform.Find("top").GetComponent<Image>().sprite = LoadAsset.instance.fashionClothImg[GameManager.instance.selectCloth +"_" + GameManager.instance.selectColor +"_img"];
            }
            else if (GameManager.instance.selectCloth.Substring(index + 1).Contains("bottom"))
            {
                ...
                canvasFashion.transform.Find("bottom").GetComponent<Image>().sprite = LoadAsset.instance.fashionClothImg[GameManager.instance.selectCloth + "_" + GameManager.instance.selectColor + "_img"];
            }
            ...
            GameManager.instance.fashionCharacter.transform.Find(GameManager.instance.selectCloth).GetComponent<Renderer>().material.mainTexture = LoadAsset.instance.fashionMaterialsImg[GameManager.instance.selectCloth + "_" + GameManager.instance.selectColor];
